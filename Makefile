...
SOURCEFILES := src/ntfs-3g-cli.c src/ntfs-3g-fuse.c
EXTERNAL_LIBS := 
...
$(BINARYDIR)/ntfs-3g-cli.o : src/ntfs-3g-cli.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/ntfs-3g-fuse.o : src/ntfs-3g-fuse.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)

...
// ========== POSIX 基础头文件（解决 malloc/free/errno/DT_DIR 缺失） ==========
#include <stdlib.h>   // malloc/free/atol
#include <errno.h>    // errno
#include <dirent.h>   // DT_DIR/d_type
#include <sys/stat.h> // S_IFLNK/S_ISGID
...
#include <stdint.h>
#include <sys/stat.h>
// ========== 极简 Windows 基础类型定义（仅保留程序必需，避免冲突） ==========
// 基础类型
...
// API 声明（仅声明，链接时由 Cygwin 提供）
void* GlobalAlloc(ULONG flags, ULONG size);
